...
export default function LoginPage() {
    ...
    useEffect(() => {
        const flashEffect = () => {
            // sometimes, if users logs in using google oauth, and user refreshes this page, then before rendering this page, the router redirects as the user is logged in. This page's useEffect runs after the redirect on the dashboard page and DOM doesn't find the button with id 'flashBtn'. Therefore, I have used optional chaining at 'addEventListener'
                ...
                <div className="loginForm_container">
                    {
                        isLoading ? (
                            <>
                                    ...
                                    <form>
                                        <p className='animate_bg animate_bg_text p-1 mb-1'>&nbsp;</p>

                                        <p className='animate_bg animate_bg_text p-1 mb-1'>&nbsp;</p>

                                        <p className='animate_bg animate_bg_text w-100 p-1 mb-1'>&nbsp;</p>
                                    </form>
                            </>
                        ) : (
                            <>
                                ...
                                <form onSubmit={handleSubmit}>
                                    <button className="googleLoginBtn" onClick={googleLoginHandler}>
                                        ...
                                        <span className="googleLoginBtnText">Log In with Google</span>
                                    </button>
                                    ...
                                    <input id="flashBtn" type="submit" value="Login" />
                                </form>
                            </>
                        )
                    }
